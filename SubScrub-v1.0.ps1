# SubScrub - Advanced Subtitle & CC Management Utility v1.0
...
# Languages to KEEP (Initial List)
$keepLanguages = New-Object System.Collections.Generic.List[string]
$keepLanguages.AddRange(@("english", "eng", "en", "en-us"))
...
# --- INITIALIZATION ---
Clear-Host
$host.ui.RawUI.WindowTitle = "SubScrub v1.0 - Subtitle Management Utility"
...
Write-Host "           SubScrub v1.0" -ForegroundColor Green
...
# 2. Interactive Language Addition
...
Write-Host "`nCurrent Keep List: $($keepLanguages -join ', ')" -ForegroundColor White
...
if (-not [string]::IsNullOrWhiteSpace($extraLang)) {
    $extraLang.Split(',') | ForEach-Object { $keepLanguages.Add($_.Trim().ToLower()) }
